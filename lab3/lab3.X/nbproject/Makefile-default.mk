...
SOURCEFILES_QUOTED_IF_SPACED=lab03.c LCD.c ADC.c USART.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/lab03.p1 ${OBJECTDIR}/LCD.p1 ${OBJECTDIR}/ADC.p1 ${OBJECTDIR}/USART.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/lab03.p1.d ${OBJECTDIR}/LCD.p1.d ${OBJECTDIR}/ADC.p1.d ${OBJECTDIR}/USART.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/lab03.p1 ${OBJECTDIR}/LCD.p1 ${OBJECTDIR}/ADC.p1 ${OBJECTDIR}/USART.p1

# Source Files
SOURCEFILES=lab03.c LCD.c ADC.c USART.c
...
dist/${CND_CONF}/${IMAGE_TYPE}/lab3.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/lab3.X.${IMAGE_TYPE}.map  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fshort-double -fshort-float -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mno-download -mno-stackcall -std=c99 -gdwarf-3 -mstack=compiled:auto:auto     $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/lab3.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
